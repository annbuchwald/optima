...
def getResponseFromAzureAI(question):
    load_dotenv()
    azure_endpoint = os.getenv("CHAT_AZURE_OAI_ENDPOINT")
    azure_deployment = os.getenv("CHAT_AZURE_OAI_DEPLOYMENT")
    api_key = os.getenv("CHAT_AZURE_OAI_KEY")
...
#         chat_azure_api_version = os.getenv("CHAT_AZURE_API_VERSION")
...
#
#         # API versions
#         api_version = os.getenv("AZURE_OAI_API_VERSION", chat_azure_api_version)
...
#
#         # Dla przykładu zostawiam, to było do testowania kodu Mikołaja, możecie zakomenotwac/zmienic
#         # file_path = "C:/Users/Boniek/Desktop/Biblioteka Raylib/raylib/src/raymath.h"
#         # # file_path = None
#         # directory_path = None
#         # max_complexity = 1
#         # regex_patterns = ["^[^_]*$"]
#         # extensions = [".h", ".cpp", ".c"]
#         # include_lines = True
#         # analyzedCode = run_analysis(file_path=file_path,
...
#         #
#         # print(analyzedCode)
#         # # givenCode = extract_function_code(file_path,29,47)
#         # # print(givenCode)
#         # language = detect_language(file_path)
#         # print(language)
#         # # ################################################
#         # user_question = f"Here is a function written in {language}. Please analyze and suggest possible improvements in:\n {analyzedCode}",
#
